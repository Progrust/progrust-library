...
| SP1 | [side-pane-scroll.md](side-pane-scroll.md) | サイドペイン（左右レール）の縦スクロール対応（GitHub issue #2） | 完了（アーカイブ済み） |
| DP1 | [dict-pane-expand.md](dict-pane-expand.md) | 辞書ペインの拡大表示（非モーダル右ドロワー。GitHub issue #1） | 完了（アーカイブ済み） |
