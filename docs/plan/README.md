...
| [P2 Markdownパイプライン統合](phase-2-pipeline.md) | 残りプラグイン統合（directives / link-card / mermaid / shiki） | P1 | 完了 |
| [P3 ページ・レイアウト](phase-3-pages.md) | 全画面の静的表示 + テーマ切替 | P2 | 完了 |
| [P4 wikilink UI](phase-4-wikilink-ui.md) | embedパーシャル・プレビュー・サイドペイン・逆リンク | P3 | 完了 |
| [P5 検索](phase-5-search.md) | インデックス生成・クエリパーサ・検索UI・一覧絞込 | P3（P4と並行可） | 完了 |
| [P6 周辺機能とリリース](phase-6-launch.md) | RSS/sitemap/OGP・フォント決定・CFセットアップ・Actions・公開 | P4, P5 | 完了 |
